...
public class ConsoleUI
{
    ...
    public ConsoleUI(AccountService accountService, AdminService adminService)
    {
            ...
            try
            {
                switch (choice)
                {
                    ...
                    case "4":
                        ...
                        {
                            {
                                IEnumerable<Domain.Entities.Operation> operations =
                                    _accountService.GetOperationsHistory(accountNumber, pin);
                                Console.WriteLine("История операций:");
                                foreach (Domain.Entities.Operation op in operations)
                                {
