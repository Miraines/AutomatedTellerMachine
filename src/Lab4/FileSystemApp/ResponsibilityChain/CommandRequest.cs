...
public class CommandRequest
{
    ...
    public ICommandStrategy? Strategy { get; private set; } = new LocalFileCommands();
    ...
    private void ParseArguments()
    {
        ...
        {
            if (_arguments[i].StartsWith("-m") || _arguments[i].StartsWith("/m"))
            {
            ...
            else if (_arguments[i].StartsWith("-d") || _arguments[i].StartsWith("/d"))
            {
